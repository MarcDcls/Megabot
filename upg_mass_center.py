...
def body_center_of_mass(passenger_weight=80.):
    """
    ...
    :param passenger_weight: si passager il y a, sa masse, sinon 0
...
def center_of_mass(V, passenger_weight=80.):
    """
    ...
    """
    m, w = body_center_of_mass(passenger_weight=passenger_weight)
    G = m * w
    total_weight = w
...
def proj_center_of_mass_robot(passenger=True, passenger_weight=80.):
    """
    ...
    """
    return project(center_of_mass(get_verins_12(), passenger_weight=passenger_weight))
